...
**Jammming App** is a web application where friends can spli. The app shows how much one owes the other. Also more friends can be added to the eat and split bill app.
