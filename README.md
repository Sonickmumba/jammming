...
**Jammming App** is a web application is that allows one to search fro songs from spotify and create playlist. 
...
```sh
  cd my-folder
  git clone git@github.com:Sonickmumba/jammming.git
```
