...
**Jammming App** is a web application is that allows one to search fro songs from spotify and app. The app shows how much one owes the other. Also more friends can be added to the eat and split bill app.
